...
import { removeItemFromLocalStorage, setItemFromLocalStorage } from "../utils/helper";
...
const authSlice = createSlice({
    ...
    reducers: {
        ...
        setWalletAddress: (state, action) => {
            const { sWalletAddress, sToken , isVerified , sEmail  , sUsername , sUserProfileImage} = action.payload; 
...
export const { setUser, setProvider, setWalletAddress, disconnectWallet } = authSlice.actions;
