    ...
    if (error.status === 404) {
      return (
        <div className='text-center text-gray-400 py-12'>
          ...
          <button
            onClick={() => { navigate('/home'); queryClient.invalidateQueries(['nfts']); }}
            className='mt-6 px-6 py-3 bg-teal-600 text-white font-semibold rounded-full shadow-lg hover:bg-teal-700 transition duration-300'
          >
            Go Back
          </button>
        </div>
      ...
      {/* <div className="mb-8 flex justify-center items-center relative max-w-3xl mx-auto">
        ...
        <div className="ml-2 mr-2 relative group">
          <select 
            ...
            className="px-8 py-4 bg-white/10 backdrop-blur-md border-2 border-transparent rounded-full shadow-lg transition-all duration-300 text-gray-200 placeholder-gray-400 text-lg font-medium hover:bg-white/20 hover:shadow-xl appearance-none cursor-pointer"
          ...
          <div className="absolute right-2 top-1/2 transform -translate-y-1/2 pointer-events-none text-teal-400 group-hover:text-teal-300 transition-colors duration-300">
            ...
            page.data.nfts.map((nft) => (
              ...
              >
                ...
                {nft.isApprovedForAuction ? (
                  ...
                  <div className="text-sm text-gray-400 font-semibold text-center bg-gray-600 px-2 py-1">
                    NOT LISTED
                  </div>
                )}
              </Link>
